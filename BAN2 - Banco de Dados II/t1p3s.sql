...
ALTER TABLE IF EXISTS public."Hotel" 
	ADD CONSTRAINT unique_codigo_visita UNIQUE(codigo_visita);
...
ALTER TABLE IF EXISTS public."Casa de Show"
	ADD CONSTRAINT unique_codigo_pontoturistico UNIQUE(codigo_pontoturistico);
